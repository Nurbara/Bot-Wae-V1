...
JIKA BERMINAT SILAHKAN HUBUNGI OWNER BOT
https://wa.me/message/FXLN3NJ45WZMM1`
...
case 'sourcode':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
fakeitem(`https://github.com/Nurbara/Bara-V1_`)
break
case 'rules':
case 's&k':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
sendButton(from, `Silakan Pilih Salah Satu`, `*_Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ_*`, but)
break
case 'public':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!mek.key.fromMe && !isOwner) return reply('Luh Siapa Sih Bang ?')
...
sendButton(from, `${menu}`, `*_Made-With-By-ʙᴏᴛᴢᴢ ᴍᴇᴇ_*`, but)
}
break
case 'autoketik':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
